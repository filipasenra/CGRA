...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //Factor to multiple ambient Light
    ...
    initMaterials() {
        ...
        // Wood (no ambient, no diffuse)
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(96/255.0, 71/255.0, 17/255.0, 1.0);
        this.material4.setDiffuse(163/255.0, 122/255.0, 34/255.0, 1.0);
