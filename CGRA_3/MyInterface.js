...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // Another forlder for grouping the custom material's parameters
        ...
        //Global Light slider and update
        var f3 = this.gui.addFolder('Global Light');
        //OnChange chama a função para atualizar a Global Light
        f3.add(this.scene, 'ambientLightFactor',0.01, 1.0).name("Ambient Factor").onChange(this.scene.updateAmbientLight.bind(this.scene));
